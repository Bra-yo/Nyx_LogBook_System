...
export async function GET() {
  try {
    ...
    console.error("Error fetching admin competency assessments:", error);
  ...
  try {
    ...
    const assessment = await prisma.competencyAssessment.create({
      data: {
        ...
        assessedByAdminId: adminProfile.id,
    ...
    console.error("Error creating admin competency assessment:", error);
