...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    if (existingAssessment.assessedBySupervisorId !== supervisorProfile.id) {
    ...
    console.error("Error updating supervisor competency assessment:", error);
...
export async function DELETE(_request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.error("Error deleting supervisor competency assessment:", error);
